...
abstract class Ep_Db_DbTable extends Zend_Db_Table_Abstract
{
	...
	{		
        ...
        if ($_GET['sql_debug']){
            echo "\n<pre style='text-align:left;font-family:consolas,monospace;padding:10px;background:#CCFFCC;color:black;font-weight:bold;overflow:auto;margin:10px;'>\n";
            //echo $query."\n";
            //echo "Time consumed: ".$elapsed."\n";
            echo $elapsed."\n";
            $e = new Exception();
	...
	protected function insertQuery($data=NULL)
	{
		...
		try
		{
			$this->_setAdapter($this->dbController_obj->dbConnectAction(NULL,NULL,NULL,NULL,NULL,true));
		}
		catch(Exception $e)
		{
			return false;
