...
class TemplateController extends Ep_Controller_Action
{
	...
	/* Interface to add/edit or delete validation templates or refusal reasons*/
	...
	/* Ajax call to check default validation templates*/
   ...
   ////////displays the email template list//////////////
	...
	public function partnersAction()
	{
		...
		if($_POST['partner_submit']!="")
		{
			if($_POST['name']!="")
			{
				...
				/*if($_FILES['partnerlogo']['tmp_name']!='')
				{
					 $tmpName = $_FILES['partnerlogo']['tmp_name'];
						$logoName = $_FILES['partnerlogo']['name'];
						$ext = explode('.', $logoName);
						$extension = $ext[1];
						if($ext[1]=="jpg")
							$logofilename=$pid.".".$ext[1];
						else
							$logofilename=$pid.".jpg";
					 $newfile="/home/sites/site5/web/FO/images/logos/partners/".$logofilename;
    ...
    public function uploadpartnerpicAction()
    {
		...
		{
			$uploadpicdir = "/home/sites/site5/web/FO/images/logos/references/";
			$partner_picture=$uploadpicdir."ReferenceLogo_".$uni.".".$ext;
			$fologopath="images/logos/references/ReferenceLogo_".$uni.".".$ext;
		}
		else
		{
			$uploadpicdir = "/home/sites/site5/web/FO/images/logos/partners/";
        ...
        if($width>=60 && $height>=30)
        {
            if (move_uploaded_file($_FILES['uploadpic']['tmp_name'], $partner_picture))
            {
                ...
                echo json_encode($array);//echo "12345";exit;
                //echo "success";
            }
            else
            {
	...
	public function referencesAction()
	{
		...
		if($_POST['reference_submit']!="")
		{
			if($_POST['name']!="")
			{
				...
				/*if($_FILES['referencelogo']['tmp_name']!='')
				{
					 $tmpName = $_FILES['referencelogo']['tmp_name'];
						$logoName = $_FILES['referencelogo']['name'];
						$ext = explode('.', $logoName);
						$extension = $ext[1];
						if($ext[1]=="jpg")
							$logofilename=$pid.".".$ext[1];
							...
							$logofilename=$pid.".jpg";
					 $newfile="/home/sites/site5/web/FO/images/logos/references/".$logofilename;
					 move_uploaded_file($tmpName, $newfile);
				}*/
			}
		}
	...
	public function cguAction()
	{
		if($_POST['cgu_submit']!="")
		{
			if($_POST['title']!="" && $_POST['content']!="")
			{
				...
				$doc->save("/home/sites/site5/web/FO/cgu/cgu.xml"); 
			}
		}
	...
	public function termsAction()
	{
		if($_POST['term_submit']!="")
		{
			if($_POST['title']!="" && $_POST['content']!="")
			{
				...
				$doc->save("/home/sites/site5/web/FO/cgu/terms.xml"); 
			}
		}
	...
	public function contacttextAction()
	{
		if($_POST['contact_submit']!="")
		{
			if($_POST['content']!="")
			{
				...
				$doc->save("/home/sites/site5/web/FO/cgu/contact.xml"); 
			}
		}
