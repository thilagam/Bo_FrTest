...
!function ($) {
    ...
    var CustomFileInput = function (content, options) {
        ...
        this.$uploadFeedback = $('<input type="text" readonly="readonly" class="customfile-feedback inline ' + this.options.classes + '" aria-hidden="true" value="' + this.options.feedback_text + '"/>').appendTo(this.$upload);
        //create custom control button
        this.$uploadButton = $('<span class="add-on customfile-button inline" aria-hidden="true">' + this.options.button_text + '</span>').css({ float : this.options.button_position });
