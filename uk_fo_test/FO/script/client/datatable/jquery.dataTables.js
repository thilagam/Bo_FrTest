...
(/** @lends <global> */function($, window, document, undefined) {
			...
			for ( var i=0 ; i<aDom.length ; i++ )
			{
				...
				if ( cOption == '<' )
				{
					...
					if ( cNext == "'" || cNext == '"' )
					{
						...
						if ( sAttr == "H" )
						{
							sAttr = "fg-toolbar ui-toolbar ui-widget-header1 ui-corner-tl ui-corner-tr ui-helper-clearfix";
						}
						else if ( sAttr == "F" )
						{
							sAttr = "fg-toolbar ui-toolbar ui-widget-header1 ui-corner-bl ui-corner-br ui-helper-clearfix";
						}
	...
	DataTable.defaults = {
		 ...
		 *       <ul>
		 *         <li>'H' - jQueryUI theme "header" classes ('fg-toolbar ui-widget-header1 ui-corner-tl ui-corner-tr ui-helper-clearfix')</li>
		 *         <li>'F' - jQueryUI theme "footer" classes ('fg-toolbar ui-widget-header1 ui-corner-bl ui-corner-br ui-helper-clearfix')</li>
		 *       </ul>
		 *     </li>
